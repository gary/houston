class Mailer < ActionMailer::Base
  default from: ::Configuration::Mailer.settings[:from] if ::Configuration::Mailer.configured?
  ...
  def send_pm_changed_notification(project, new_project_manager)
    ...
    mail to: ::Configuration::Mailer.settings[:scheduler_email],
  ...
  def send_token_notification
    mail to: Configuration::Mailer.settings[:scheduler],
