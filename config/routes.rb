WeeklySchedule::Application.routes.draw do
  ...
  namespace :settings do
    get 'mail_templates/edit', to: 'mail_templates#edit',   as: :edit_mail_templates
    put 'mail_templates',      to: 'mail_templates#update', as: :update_mail_templates
  ...
  put 'settings/:auto_mail', :to => 'settings#update', :as => :setting
  put 'mail_settings', :to => 'settings#update', :as => :mail_settings
  get 'settings/:auto_mail', :to => 'settings#update', :as => :setting_mails
